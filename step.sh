...
echo "$(date +"%H:%M:%S") - git fetch --verbose --progress --no-tags --jobs=10 origin refs/heads/$branch"
git fetch --verbose --progress --no-tags --jobs=10 origin refs/heads/$branch
